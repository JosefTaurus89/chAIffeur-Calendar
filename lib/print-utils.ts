...
export const generateVoucherPDF = (service: Service, driver: User | undefined, settings: AppSettings) => {
    ...
    const formatCurrency = (amount: number) => new Intl.NumberFormat(locale, { style: 'currency', currency: settings.currency }).format(amount);
    ...
    <head>
        ...
        <style>
            ...
            .voucher-title { font-weight: bold; font-size: 20px; letter-spacing: 2px; border: 2px solid #fff; padding: 10px 20px; text-transform: uppercase; }
    ...
    <body>
        <div class="voucher">
            <div class="header">
                ${companyInfo}
                <div class="voucher-title">${settings.reportHeader || t('voucher_header')}</div>
            </div>
            ...
            <div class="content">
                <div>
                    ...
                    <div class="section">
                        ...
                        <div class="info-row">
                             ...
                             <span class="info-value large-value" style="${balanceDue > 0 ? 'color: #c0392b;' : ''}">${formatCurrency(balanceDue)}</span>
                        </div>
                    </div>
                </div>
                ...
                <div>
                     <div class="section">
                        <div class="section-title">${t('service_type')}</div>
                        ...
                        <div class="address-box" style="border-left-color: #777;">
                            <div class="address-label">${t('stop_waypoint')}</div>
            ...
            <div class="footer">
                ${settings.reportFooter || t('voucher_footer')}
            </div>
        </div>
        <script>
             window.onload = () => { setTimeout(() => window.print(), 500); }
